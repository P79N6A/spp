...
// Generated from `coming_one_rank.jce'
// **********************************************************************

#ifndef __COMING_ONE_RANK_H_
#define __COMING_ONE_RANK_H_
...
namespace ComingOneRank
{
    ...
    public:
        ...
        {
            return "ComingOneRank.STFansInfo";
        }
        static string MD5()
        {
            return "1ec0f2ae7b52c7b38903b66df430dd41";
        }
        STFansInfo()
        :lScore(0),iRank(0),strPersonalLink("")
        {
        }
        void resetDefautlt()
        {
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(strPersonalLink, false);
            return _os;
        }
    public:
    ...
    {
        return l.stFansData == r.stFansData && l.lScore == r.lScore && l.iRank == r.iRank && l.strPersonalLink == r.strPersonalLink;
    }
    inline bool operator!=(const STFansInfo&l, const STFansInfo&r)
    {
        return !(l == r);
    ...
    public:
        static string className()
        {
            return "ComingOneRank.BannerImg";
        }
        static string MD5()
        {
    ...
    public:
        static string className()
        {
            return "ComingOneRank.stFansRankReq";
        }
        static string MD5()
        {
    ...
    public:
        static string className()
        {
            return "ComingOneRank.stFansRankRsp";
        }
        static string MD5()
        {
            return "775a600e1b129540a3ca43c894724542";
        }
        stFansRankRsp()
    ...
    public:
        ...
        taf::UInt32 iPeriod;
        ComingOneRank::BannerImg stBannerImg;
        vector<ComingOneRank::STFansInfo> vecUserInfo;
    ...
    struct STChannelVoteInfo : public taf::JceStructBase
    {
    public:
        static string className()
        {
            return "ComingOneRank.STChannelVoteInfo";
        }
        static string MD5()
        {
        ...
        STChannelVoteInfo()
        :lTotalVoteNum(0),iTotalVoteFans(0)
        {
        }
        void resetDefautlt()
        {
        ...
        void writeTo(taf::JceOutputStream<WriterT>& _os) const
        {
            _os.write(lTotalVoteNum, 0);
            _os.write(iTotalVoteFans, 1);
        }
        template<typename ReaderT>
        void readFrom(taf::JceInputStream<ReaderT>& _is)
        {
            resetDefautlt();
            _is.read(lTotalVoteNum, 0, false);
            _is.read(iTotalVoteFans, 1, false);
        }
        ostream& display(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.display(lTotalVoteNum,"lTotalVoteNum");
            _ds.display(iTotalVoteFans,"iTotalVoteFans");
            return _os;
        }
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.displaySimple(lTotalVoteNum, true);
            _ds.displaySimple(iTotalVoteFans, false);
            return _os;
        }
    public:
        taf::Int64 lTotalVoteNum;
        taf::Int32 iTotalVoteFans;
    };
    inline bool operator==(const STChannelVoteInfo&l, const STChannelVoteInfo&r)
    {
        return l.lTotalVoteNum == r.lTotalVoteNum && l.iTotalVoteFans == r.iTotalVoteFans;
    }
    inline bool operator!=(const STChannelVoteInfo&l, const STChannelVoteInfo&r)
    {
        return !(l == r);
    ...
    struct stChannelVoteReq : public taf::JceStructBase
    {
    public:
        static string className()
        {
            return "ComingOneRank.stChannelVoteReq";
        }
        static string MD5()
        {
        ...
        void writeTo(taf::JceOutputStream<WriterT>& _os) const
        {
            _os.write(vecChannelId, 0);
        }
        template<typename ReaderT>
        void readFrom(taf::JceInputStream<ReaderT>& _is)
        {
            resetDefautlt();
            _is.read(vecChannelId, 0, false);
        }
        ostream& display(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.display(vecChannelId,"vecChannelId");
            return _os;
        }
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.displaySimple(vecChannelId, false);
            return _os;
        }
    public:
        vector<std::string> vecChannelId;
    };
    inline bool operator==(const stChannelVoteReq&l, const stChannelVoteReq&r)
    {
        return l.vecChannelId == r.vecChannelId;
    }
    inline bool operator!=(const stChannelVoteReq&l, const stChannelVoteReq&r)
    {
        return !(l == r);
    ...
    struct stChannelVoteRsp : public taf::JceStructBase
    {
    public:
        static string className()
        {
            return "ComingOneRank.stChannelVoteRsp";
        }
        static string MD5()
        {
            return "b81988147780352df61e87266de9ce4d";
        }
        stChannelVoteRsp()
        :iErrCode(0),lTotalVoteNum(0),iTotalVoteFans(0)
        {
        }
        void resetDefautlt()
        {
        ...
        {
            _os.write(iErrCode, 0);
            _os.write(vecChannelVoteInfo, 1);
            _os.write(lTotalVoteNum, 2);
            _os.write(iTotalVoteFans, 3);
        }
        template<typename ReaderT>
        void readFrom(taf::JceInputStream<ReaderT>& _is)
        {
            resetDefautlt();
            _is.read(iErrCode, 0, false);
            _is.read(vecChannelVoteInfo, 1, false);
            _is.read(lTotalVoteNum, 2, false);
            _is.read(iTotalVoteFans, 3, false);
        }
        ostream& display(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.display(iErrCode,"iErrCode");
            _ds.display(vecChannelVoteInfo,"vecChannelVoteInfo");
            _ds.display(lTotalVoteNum,"lTotalVoteNum");
            _ds.display(iTotalVoteFans,"iTotalVoteFans");
            return _os;
        }
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.displaySimple(iErrCode, true);
            _ds.displaySimple(vecChannelVoteInfo, true);
            _ds.displaySimple(lTotalVoteNum, true);
            _ds.displaySimple(iTotalVoteFans, false);
            return _os;
        }
    public:
        taf::Int32 iErrCode;
        vector<ComingOneRank::STChannelVoteInfo> vecChannelVoteInfo;
        taf::Int64 lTotalVoteNum;
        taf::Int32 iTotalVoteFans;
    };
    inline bool operator==(const stChannelVoteRsp&l, const stChannelVoteRsp&r)
    {
        return l.iErrCode == r.iErrCode && l.vecChannelVoteInfo == r.vecChannelVoteInfo && l.lTotalVoteNum == r.lTotalVoteNum && l.iTotalVoteFans == r.iTotalVoteFans;
    }
    inline bool operator!=(const stChannelVoteRsp&l, const stChannelVoteRsp&r)
    {
        return !(l == r);
    ...
    public:
        static string className()
        {
            return "ComingOneRank.STStarInfo";
        }
        static string MD5()
        {
    ...
    public:
        static string className()
        {
            return "ComingOneRank.STStarData";
        }
        static string MD5()
        {
    ...
    public:
        static string className()
        {
            return "ComingOneRank.STStarRankInfo";
        }
        static string MD5()
        {
            return "98733f8cd13672726aed40d4ed083d30";
        }
        STStarRankInfo()
        {
        }
    ...
    public:
        ComingOneRank::STStarInfo stInfo;
        ComingOneRank::STStarData stData;
    };
    ...
    public:
        static string className()
        {
            return "ComingOneRank.stStarRankReq";
        }
        static string MD5()
        {
            return "d3671a7a05bcc724d3359a552e2939b8";
        }
        stStarRankReq()
        :iReqTime(0),iState(0),iStarType(0),iReqType(0),iNum(0),iPage(0),strStarId(""),iFrom(0)
        {
        }
        void resetDefautlt()
        {
        ...
        void writeTo(taf::JceOutputStream<WriterT>& _os) const
        {
            ...
            _os.write(iState, 1);
            _os.write(iStarType, 2);
            _os.write(iReqType, 3);
            _os.write(iNum, 4);
            _os.write(iPage, 5);
            _os.write(strStarId, 6);
            _os.write(iFrom, 7);
        }
        template<typename ReaderT>
        void readFrom(taf::JceInputStream<ReaderT>& _is)
        {
            ...
            _is.read(iStarType, 2, true);
            _is.read(iReqType, 3, true);
            _is.read(iNum, 4, false);
            _is.read(iPage, 5, false);
            _is.read(strStarId, 6, false);
            _is.read(iFrom, 7, false);
        }
        ostream& display(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
    ...
    {
        return l.iReqTime == r.iReqTime && l.iState == r.iState && l.iStarType == r.iStarType && l.iReqType == r.iReqType && l.iNum == r.iNum && l.iPage == r.iPage && l.strStarId == r.strStarId && l.iFrom == r.iFrom;
    }
    inline bool operator!=(const stStarRankReq&l, const stStarRankReq&r)
    {
        return !(l == r);
    ...
    public:
        static string className()
        {
            return "ComingOneRank.stStarRankRsp";
        }
        static string MD5()
        {
            return "132a19bf3ab5d4ec1a8d44898e742084";
        }
        stStarRankRsp()
        :iErrCode(0),iPeriod(0),iNextPage(0),iCurPage(0),iTotalPage(0)
        {
        }
        void resetDefautlt()
        {
        ...
        void writeTo(taf::JceOutputStream<WriterT>& _os) const
        {
            ...
            _os.write(iPeriod, 2);
            _os.write(iNextPage, 3);
            _os.write(iCurPage, 4);
            _os.write(iTotalPage, 5);
        }
        template<typename ReaderT>
        void readFrom(taf::JceInputStream<ReaderT>& _is)
        {
            ...
            _is.read(iPeriod, 2, false);
            _is.read(iNextPage, 3, false);
            _is.read(iCurPage, 4, false);
            _is.read(iTotalPage, 5, false);
        }
        ostream& display(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            ...
            _ds.display(iPeriod,"iPeriod");
            _ds.display(iNextPage,"iNextPage");
            _ds.display(iCurPage,"iCurPage");
            _ds.display(iTotalPage,"iTotalPage");
            return _os;
        }
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            taf::JceDisplayer _ds(_os, _level);
            _ds.displaySimple(iErrCode, true);
            _ds.displaySimple(vecStarInfo, true);
            _ds.displaySimple(iPeriod, true);
            _ds.displaySimple(iNextPage, true);
            _ds.displaySimple(iCurPage, true);
            _ds.displaySimple(iTotalPage, false);
            return _os;
        }
    public:
        taf::Int32 iErrCode;
        vector<ComingOneRank::STStarRankInfo> vecStarInfo;
        taf::UInt32 iPeriod;
        taf::UInt32 iNextPage;
        taf::UInt32 iCurPage;
        taf::UInt32 iTotalPage;
    };
    inline bool operator==(const stStarRankRsp&l, const stStarRankRsp&r)
    {
        return l.iErrCode == r.iErrCode && l.vecStarInfo == r.vecStarInfo && l.iPeriod == r.iPeriod && l.iNextPage == r.iNextPage && l.iCurPage == r.iCurPage && l.iTotalPage == r.iTotalPage;
    }
    inline bool operator!=(const stStarRankRsp&l, const stStarRankRsp&r)
    {
        return !(l == r);
    ...
    public:
        static string className()
        {
            return "ComingOneRank.FansVoteFLowDataReq";
        }
        static string MD5()
        {
    ...
    public:
        static string className()
        {
            return "ComingOneRank.FansVoteFLowDataRsp";
        }
        static string MD5()
        {
            return "7a77e356a830177c0e77fe3a99a251b6";
        }
        FansVoteFLowDataRsp()
...
#define ComingOneRank_STFansInfo_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.stFansData,b.stFansData);jce_copy_struct(a.lScore,b.lScore);jce_copy_struct(a.iRank,b.iRank);jce_copy_struct(a.strPersonalLink,b.strPersonalLink);

#define ComingOneRank_BannerImg_JCE_COPY_STRUCT_HELPER   \
...
#define ComingOneRank_stFansRankReq_JCE_COPY_STRUCT_HELPER   \
...
#define ComingOneRank_stFansRankRsp_JCE_COPY_STRUCT_HELPER   \
...
#define ComingOneRank_STChannelVoteInfo_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.lTotalVoteNum,b.lTotalVoteNum);jce_copy_struct(a.iTotalVoteFans,b.iTotalVoteFans);

#define ComingOneRank_stChannelVoteReq_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.vecChannelId,b.vecChannelId);

#define ComingOneRank_stChannelVoteRsp_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.iErrCode,b.iErrCode);jce_copy_struct(a.vecChannelVoteInfo,b.vecChannelVoteInfo);jce_copy_struct(a.lTotalVoteNum,b.lTotalVoteNum);jce_copy_struct(a.iTotalVoteFans,b.iTotalVoteFans);

#define ComingOneRank_STStarInfo_JCE_COPY_STRUCT_HELPER   \
...
#define ComingOneRank_STStarData_JCE_COPY_STRUCT_HELPER   \
...
#define ComingOneRank_STStarRankInfo_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.stInfo,b.stInfo);jce_copy_struct(a.stData,b.stData);

#define ComingOneRank_stStarRankReq_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.iReqTime,b.iReqTime);jce_copy_struct(a.iState,b.iState);jce_copy_struct(a.iStarType,b.iStarType);jce_copy_struct(a.iReqType,b.iReqType);jce_copy_struct(a.iNum,b.iNum);jce_copy_struct(a.iPage,b.iPage);jce_copy_struct(a.strStarId,b.strStarId);jce_copy_struct(a.iFrom,b.iFrom);

#define ComingOneRank_stStarRankRsp_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.iErrCode,b.iErrCode);jce_copy_struct(a.vecStarInfo,b.vecStarInfo);jce_copy_struct(a.iPeriod,b.iPeriod);jce_copy_struct(a.iNextPage,b.iNextPage);jce_copy_struct(a.iCurPage,b.iCurPage);jce_copy_struct(a.iTotalPage,b.iTotalPage);

#define ComingOneRank_FansVoteFLowDataReq_JCE_COPY_STRUCT_HELPER   \
        jce_copy_struct(a.strStarId,b.strStarId);

#define ComingOneRank_FansVoteFLowDataRsp_JCE_COPY_STRUCT_HELPER   \
